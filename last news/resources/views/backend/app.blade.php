...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-white-primary elevation-4"  >
        <a href="{{ route('index') }}" class="brand-link">
            <img src="{{$site_image}}"  alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Son Dakika </span>
        </a>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2" >
                <ul class="nav  nav-sidebar  flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="{{route('index')}}" class="nav-link {{ request()->is('/anasayfa') ? 'active' : ''}}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{route('pages')}}" class="nav-link {{ request()->is('admin/pages') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Yurt Dışı Haber Listesi</p>
                                </a>
                            </li>
                          
                            
                    <li class="nav-item has-treeview">
                        <a href="#" class="nav-link"{{ request()->is('admin/menus','admin/menus/menu-add','admin/menus/menu-edit/*') ? 'menu-open' : '' }}">
    ...
    <footer class="main-footer">
        <strong>Bahadır Bağoğlu</a>.</strong>
    </footer>
</div>
