                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($pages as $page)
                                <tr>
                                    <td><img width="325" src="{{$page->page_image}}" height="200"></td>
                                    ...
                                    <td>
                                        ...
                                        @if($page->page_status == 'on')
                                            <button class="btn btn-success" onclick="pageStatus(this,'{{$page->id}}','off')"><i class="fas fa-eye"></i>Aktif</button>
                                        @else
                                            <button class="btn btn-success" onclick="pageStatus(this,'{{$page->id}}','on')"><i class="fas fa-eye-slash"></i>Pasif</button>
                                        @endif
