                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="page_name" class="form-control" placeholder="Başlık Yazınız">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="page_description" class="form-control" placeholder="Kısa Açıklama Yazınız">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">İlgili Kaynaklar </label>
                                    <input type="text" name="page_tags" class="form-control" placeholder="İlgili Kaynaklar">
                                </div>
                                <div class="form-group">
                                    <label>İçerik</label>
