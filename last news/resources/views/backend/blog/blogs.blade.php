            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tr>
                            <td><img width="325" src="{{$blog->blog_image}}" height="200"></td>
                            ...
                            <td>
                                ...
                                @if($blog->blog_status == 'on')
                                    <button class="btn btn-success" onclick="blogsStatus(this,'{{$blog->id}}','off')"><i class="fas fa-eye"></i>Aktif</button>
                                @else
                                    <button class="btn btn-success" onclick="blogsStatus(this,'{{$blog->id}}','on')"><i class="fas fa-eye-slash"></i>Pasif</button>
                                @endif
                            </td>
                        </tr>
                        @endforeach
