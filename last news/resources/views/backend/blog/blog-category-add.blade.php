...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Haber Kategori Ekle</h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category_name" class="form-control" placeholder="Kategori Adı Yazınız">
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="input-group"><br>
                                            <input type="checkbox" name="category_status" checked data-bootstrap-switch><br>
                                        </div>
                                    </div>
                                </div>
                            </div>
