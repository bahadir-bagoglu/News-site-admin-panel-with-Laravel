                ...
                <form method="post"enctype="multipart/form-data">
                    ...
                    <div class="row">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="blog_title" class="form-control" placeholder="Başlık Yazınız">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <input type="text" name="blog_description" class="form-control" placeholder="Kısa Açıklama Yazınız">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">İlgili Kaynak</label>
                                        <input type="text" name="blog_tags" class="form-control" placeholder="İlgili Kaynak">
                                    </div>
                                    <div class="form-group">
                                        <label>İçerik</label>
                        ...
                        <div class="col-md-3">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Haber Resim</h3>
                                </div>
                                <br>
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Haber Görünürlüğü</h3>
                                </div>
                                <br>
                                <div class="card-body">
                                    <div class="form-group">
