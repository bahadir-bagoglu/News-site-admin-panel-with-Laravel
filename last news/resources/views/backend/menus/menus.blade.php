                                ...
                                <tr id="item-{{$menu->id}}">
                                    ...
                                    <td>
                                        ...
                                        @if($menu->menu_status == 'on')
                                            <button class="btn btn-success" onclick="menuStatus(this,'{{$menu->id}}','off')"><i class="fas fa-eye"></i>Aktif</button>
                                        @else
                                            <button class="btn btn-success" onclick="menuStatus(this,'{{$menu->id}}','on')"><i class="fas fa-eye-slash"></i>Pasif</button>
                                        @endif
                                    </td>
                                </tr>
                                    ...
                                    <tr id="item-{{$downMenu->id}}">
                                        ...
                                        <td>
                                            ...
                                            @if($downMenu->menu_status == 'on')
                                                <button class="btn btn-success" onclick="menuStatus(this,'{{$downMenu->id}}','off')"><i class="fas fa-eye"></i>Aktif</button>
                                            @else
                                                <button class="btn btn-success" onclick="menuStatus(this,'{{$downMenu->id}}','on')"><i class="fas fa-eye-slash"></i>Pasif</button>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
